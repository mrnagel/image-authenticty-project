...
parser.add_argument('-g',   '--gpu',     type=int, default=-1, help='device, use -1 for cpu') # changed default to -1 from 0
...
checkpoint = torch.load(model_state_file, map_location=torch.device(device), weights_only=False) # added weights_only = False
