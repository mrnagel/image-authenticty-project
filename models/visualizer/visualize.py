...
parser.add_argument('--image_output', type=str, default='', help='output image file')
...
ax_map.imshow(result['map'], cmap='RdBu_r', clim=[0,1]), ax.set_title('Localization map')
ax_map.tick_params(left=False, bottom=False, labelleft=False, labelbottom=False)
fig_map.savefig(args.image_output, bbox_inches='tight', pad_inches=0)